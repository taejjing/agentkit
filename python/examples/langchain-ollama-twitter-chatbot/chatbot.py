...
def initialize_agent(config: CdpEvmServerWalletProviderConfig):
    ...
    llm = ChatOllama(
        ...
        base_url=f"{os.getenv('OLLAMA_HOST')}:{os.getenv('OLLAMA_PORT')}",
    )
...
def main():
    ...
    # print("print ENVs")
    # print(os.getenv("CDP_API_KEY_ID"))
    # print(os.getenv("CDP_API_KEY_SECRET"))
    # print(os.getenv("CDP_WALLET_SECRET"))
